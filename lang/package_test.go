...
func TestPackage_dotImport(t *testing.T) {
	...
	is.Equal(pkg.Import(), `import "github.com/nomaed/gomarkdoc/testData/lang/function"`)
	is.Equal(pkg.ImportPath(), `github.com/nomaed/gomarkdoc/testData/lang/function`)
}
