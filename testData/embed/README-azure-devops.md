...
```go
import "github.com/nomaed/gomarkdoc/testData/embed"
```
...
## func [EmbeddedFunc](<https://github.com/nomaed/gomarkdoc?path=testData%2Fembed%2Fembed.go&version=GBmaster&lineStyle=plain&line=6&lineEnd=6&lineStartColumn=1&lineEndColumn=33>)
